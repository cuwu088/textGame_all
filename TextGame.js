class Player {
  ...
  var roomF1 = new Room(
    "โถงทางเดิน",
    -1,
    "ที่มุมโถงทางเดินตรงหน้าทางไปห้องนอน(east)มีกล่องไม้ที่ถูกปิดอย่างเเน่นหนาวางกองกันอยู่หลายกล่องถัดจากกล่องมี กรอบรูปเปล่า(pictureframe) ห้อยอยู่เเละดูเหทือนโถงทางเดินนี้จะกว้างไปในทางทิศเหนือ(north).",
    ["north", "east"],
    [pictureframe],
    []
  );
  ...
  var room100 = new Room(
    "ห้องนั่งเล่น",
    100,
    "มีทีวีเเละโซฟาอยู่ตรงกลางห้อง ใกล้ๆกับทางไปโถงทางเดิน(west)มีตู้ลิ้นชักและ มีกล่องไม้ที่ถูกปิดอย่างเเน่นหนาวางกองกันอยู่สองกล่องข้างทางไปโถงหน้าบ้าน(east).",
    ["west", "east"],
    [],
    []
  );
  var room101 = new Room(
    "โถงหน้าบ้าน",
    101,
    "ใกล้กับทางไปห้องนั่งเล่น(west)มีชั้นวางลองเท้าซึ่งตรงข้ามกับทางไปห้องครัว(east) เเละมีทางไปห้องเก็บของ(south)ที่ตรงข้ามกับประตูทางออก(north).",
  ...
  var room1 = new Room(
    "ห้องเก็บของ",
    1,
    "ในห้องมีเเต่มีกล่องไม้ที่ถูกปิดอย่างเเน่นหนาวางกองกันมากจนเเทบจะไม่มีที่เดินเเต่สามารถเดินไปตรงกลางห้องได้ซึงมีประตูอยู่ตรงพื้น และทางกลับไปโถงหน้าบ้าน(north).",
    ["north"],
    [],
    []
  );
