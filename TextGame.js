...
class Door extends Object {
  ...
  #status;
  #req;
  constructor(name, id, description, nextRoom, status = "notlock" , req = 6666) {
    super(name, id, description);
...
var doorB1 = new Door("ประตูชั้นใต้ดิน", 4, "เป็นประตูสี่เหลี่ยมจัตุรัสเก่าๆ", 666, "lock", 3);
var doorG1 = new Door("ประตูเก่าๆ", 5, "เป็นประตูสี่เหลี่ยมผืนผ้าเก่าๆ", 1);
...
var room1 = new Room(
  "ห้องเก็บของ",
  1,
  "ในห้องมีเเต่มีกล่องไม้วางกองกันมากจนเเทบจะไม่มีที่เดินเเต่สามารถเดินไปตรงกลางห้องได้ซึงมี ประตูชั้นใต้ดิน ที่อยู่ตรงพื้นและทางกลับไปโถงหน้าบ้าน(north).",
  ["north"],
  [woodenbox, doorB1],
  []
);
  ...
  inputElement.addEventListener("keydown", function (event) {
    if (event.key === "Enter") {
      ...
      if (input.includes("enter ")) {
        ...
        obj.next();
        fun = 0;
      } else if (input.includes("back") && fun != 0) {
          fun = 0;
